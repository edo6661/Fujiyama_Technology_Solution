<x-layouts.admin-app title="Blogs">
    <div class="flex justify-between items-center mb-6">
        <div>
            <h1 class="text-2xl font-semibold text-gray-800">Blogs</h1>
        ...
        {{-- <div class="flex items-center justify-between p-4 border-b">
            <div class="flex items-center w-full">
                <div class="relative w-full max-w-md">
                    <input type="text" placeholder="Cari blogs..." class="w-full pl-10 pr-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                        ...
                        <td class="py-4 px-6 text-center">
                            <div class="flex justify-center space-x-2">
                                ...
                                <form action="{{ route('blogs.destroy', $blog) }}" method="POST" class="inline">
                                    ...
                                    <button type="submit" class="text-red-600 hover:text-red-900" title="Hapus" onclick="return confirm('Apakah Anda yakin ingin menghapus blogs ini?')">
                        ...
                        <td colspan="5" class="py-6 px-6 text-center text-gray-500">
                            <div class="flex flex-col items-center justify-center">
                                ...
                                <p class="text-sm text-gray-500 mt-1">
                                    Start creating your first blog by clicking the button below.
                                </p>
