<ul class="space-y-2">
    ...
    <li>
        <a href="{{ route('blogs.index') }}" class="flex items-center px-4 py-3 text-gray-300 hover:bg-gray-700 hover:text-white rounded-md transition-colors {{ request()->routeIs('admin.blogs.*') ? 'bg-gray-700 text-white' : '' }}">
