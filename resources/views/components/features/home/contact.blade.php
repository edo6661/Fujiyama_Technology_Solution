            ...
            <div class="space-y-8">
                ...
                <div class="grid grid-cols-1 gap-4">
                    @foreach ($contactInfo as $info)
                        <x-features.home.contact-info-item :title="$info['title']" :content="$info['content']" :icon="$info['icon']" />
                    @endforeach
                </div>
            </div>
                    ...
                    <form class="space-y-4">
                        <div class="grid md:grid-cols-2 grid-cols-1 gap-4">
                            <div>
                                ...
                                <input type="text"
                                    class="w-full px-4 py-3 border border-gray-200 rounded-lg focus:outline-none focus:border-primary-blue transition-colors duration-300"
                        ...
                        <div>
                            ...
                            <textarea rows="7"
                                class="w-full px-4 py-3 border border-gray-200 rounded-lg focus:outline-none focus:border-primary-blue transition-colors duration-300 resize-none"
                                placeholder="Tell us about your project or challenges..."></textarea>
                        </div>
